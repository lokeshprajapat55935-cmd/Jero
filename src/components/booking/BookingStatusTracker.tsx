...
const STEPS = [
  ...
  { status: 'awaiting_item_approval', label: 'Material Approval', icon: Package },
  { status: 'awaiting_payment', label: 'Payment', icon: CreditCard },
  { status: 'work_completed_pending_otp', label: 'OTP Verification', icon: ShieldCheck },
